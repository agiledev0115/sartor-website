...
<html lang="zxx">
    <head>
        ...
        <title>Black fashion Blog</title>
                        ...
                        <div class="main-menu mobile-menu">
                            <ul>
                                <li>
                                    <div class="buttonic">
                                        <a href="./index.php">
                                            <div class="btn btn-three"><span> Home </span></div>
                                        </a>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="buttonic">
                                        <a href="#" role="menuitem">
                                            <div class="btn btn-three"><span> About</span></div>
                                        </a>
                                        <ul class="dropdown" role="menu" aria-hidden="false" style="">
                                            <li>
                                                <div class="container"><a href="./aboutus.php" role="menuitem" tabindex="0">About Us</a></div>
                                            </li>
                                ...
                                <li class="active">
                                    <div class="buttonic">
                                        <a href="./blog.php">
                                            <div class="btn btn-five"><span> Blog's </span></div>
                                        </a>
                                    </div>
                                </li>
                                <li>
                    ...
                    <div class="col-lg-6">
                        <div class="blog-item">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="bi-text text-truncate">
                                        <ul>
                                            <li>
                                                <i class=""></i>
                                                <?=date('F jS Y',strtotime($data['date']))?>
                                            </li>
                                        </ul>
                                        <h3>
                                            <a href="blog-details.php?id=<?php echo $data['id'] ?>"><?php echo $data['title']; ?></a>
                                        </h3>
                                        <!-- <a href="blog-details.php?id=<?php echo $data['id'] ?>" class="text-truncate"><?=$data['detail']; ?></a> -->
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget fw-links">
                            ...
                            <ul>
                                ...
                                <li><a href="./faq/index.php">Return Policy & FAQ</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
